...
export default class HttpHelper {
  ...
  static async __CallApi(url, method, { params, data: body, form, headers }) {
   ...
   * @memberof HttpHelper
   */
  static async onApiPut(url, { params, data, form, headers }) {
    return await this.__CallApi(url, 'put', { params, data, form, headers });
  }
   ...
   * @static
   * @param {any} url 
   * @param {any} { params, data, form, headers } 
   * @returns 
   * @memberof HttpHelper
   */
  static async onApiPost(url, { params, data, form, headers }) {
    return await this.__CallApi(url, 'post', { params, data, form, headers });
  }
